...
if(isset($_POST['cargarServicio'])){

  require ("app/cnx.php");
  $servicio = $_POST['servicio'];
  $descripcion = $_POST['descripcion'];

  $ssql = "SELECT * FROM listaservicios WHERE servicio='$servicio'";
    $rs = mysql_query($ssql,$conexion);
    if (mysql_num_rows($rs)>0)
        { 
          

          echo "Ya existe este servicio";

      
        }else{

              mysql_query ("INSERT INTO listaservicios VALUES ('','$servicio','$descripcion')");

              echo "El servicio se registro con exito";
        }
}
?>
...
<form method="post" action="#">
    ...
    <br><br>
    <input type="submit" name="cargarServicio" value="Ingresar Servicio">
</form>
</div>
