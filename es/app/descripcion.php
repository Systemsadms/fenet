...
<section>
  <div style="background-color: none; width: 100%; height: 60px; text-align: right; padding-top: 10px; padding-right: 10px;"><a href="servicios.php"><img src="img/flechave.jpg" height="50"></a></div>    
...
<br><br><br>
        <label id="validarDescripcion">Describe el Servicio:</label>
