...
<html lang="en">
  <head>
    ...
    .asesor{width: 100%; height: 60px; margin-top: 124px; background-color: green; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px; font-size: 20px; color: white; padding-top: 15px; text-align: center; cursor: pointer;}
